...
CREATE TABLE IF NOT EXISTS document_chunks (
  ...
  created_at    TIMESTAMP NOT NULL DEFAULT NOW(),
  updated_at    TIMESTAMP NOT NULL DEFAULT NOW(),
  CONSTRAINT uk_document_chunks_path_chunk UNIQUE (path, chunk_index)
);

CREATE INDEX IF NOT EXISTS idx_document_chunks_source_id ON document_chunks(source_id);
CREATE INDEX IF NOT EXISTS idx_document_chunks_semantic_hash ON document_chunks(semantic_hash);
